...
STATIC_PATHS = ['images', 'extra/favicon.ico', 'extra/CNAME', 'arquivos']
EXTRA_PATH_METADATA = {
...
SOCIAL = (('twitter', 'https://twitter.com/paulomiramor'),
          ...
          ('stackoverflow', 'http://stackoverflow.com/users/1930564/paulo-miramor?tab=profile'),          
          )
